...
canvas1 = manifest.make_canvas_from_iiif(
    url="https://tile.loc.gov/image-services/iiif/service:ndnp:oru:batch_oru_hufnagel_ver02:data:sn96061150:00200298111:1889102001:0368",
...
canvas2 = manifest.make_canvas_from_iiif(
    url="https://tile.loc.gov/image-services/iiif/service:ndnp:oru:batch_oru_hufnagel_ver02:data:sn96061150:00200298111:1889102001:0369",
...
canvas3 = manifest.make_canvas_from_iiif(
    url="https://tile.loc.gov/image-services/iiif/service:ndnp:oru:batch_oru_hufnagel_ver02:data:sn96061150:00200298111:1889102001:0370",
...
anno1 = canvas3.make_annotation(
    id="https://www.loc.gov/resource/sn96061150/1889-10-20/ed-1/seq-3/p0002-tag",
...
anno2 = canvas3.make_annotation(
    id="https://www.loc.gov/resource/sn96061150/1889-10-20/ed-1/seq-3/p0003-tag",
    motivation="commenting",
    body={
        "type": "TextualBody",
        "language": "en",
...
canvas4 = manifest.make_canvas_from_iiif(
    url="https://tile.loc.gov/image-services/iiif/service:ndnp:oru:batch_oru_hufnagel_ver02:data:sn96061150:00200298111:1889102001:0371",
